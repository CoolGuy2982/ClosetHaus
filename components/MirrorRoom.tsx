    ...
    return (
        <div className="flex flex-col h-screen">
            <header className="flex-shrink-0 flex items-center justify-between p-4 border-b border-haus-border bg-white/50 backdrop-blur-sm">
                ...
                <h1 className="text-2xl font-bold text-haus-text">Mirror Room</h1>
                <div className="w-24"></div>
            </header>

            <div className="flex-grow grid lg:grid-cols-12 gap-4 p-4 overflow-hidden">
                {/* Left Panel: Clothing Items */}
                <div className="lg:col-span-3 bg-white/50 rounded-lg border border-haus-border p-4 overflow-y-auto">
                ...
                <div className="lg:col-span-6 bg-haus-foreground rounded-lg border border-haus-border flex items-center justify-center p-4">
                ...
                {/* Right Panel: Actions */}
                <div className="lg:col-span-3 bg-white/50 rounded-lg border border-haus-border p-4 flex flex-col justify-between">
                    <div>
